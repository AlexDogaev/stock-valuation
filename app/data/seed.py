...
STRUCT = {
    ...
    "X5":   (2, 0, 0, 0, 0, 0, "РФ #1 продуктовый ритейл: масштаб+логистика+СТМ — moat 2 (эталон score 2 для PROVEN, см. quality_markers)"),
    "LKOH": (1, -1, -1, -2, 0, -2, "Энергопереход, спрос-плато, рост НДПИ/изъятие"),
    "OZON": (2, 0, 1, -1, 0, 0, "e-com #1-2, сетевой эффект+логистика; НДС/регуляторика (платформа+монетизация)"),
    ...
    # opus-draft + owner-review 24.06.2026: качественные имена, застрявшие на score 0 (баллы не были детализированы)
    "MOEX": (2, 0, 1, -1, 0, 0, "Монополия-биржа, capital-light, стабильные дивы; ЦБ-контроль (reg-1)"),
    "PLZL": (2, 0, 1, -1, 0, 0, "Золото — двойной выживальщик (Гл.11): экспорт+хедж девальвации+вне энергоперехода, низкий кост"),
    "GMKN": (2, 0, 1, -1, 0, 0, "Ni/Cu/Pd для глоб.электрификации (Гл.11), уникальные активы; payout срезан"),
    # пограничные (owner-вызов 24.06.2026): MGNT тянет на структурный тир, остальные — корректно ordinary
    "MGNT": (1, 0, 1, 0, 0, 0, "Нац.#2 продуктовый ритейл, масштаб+дефенсив-стейпл; за X5, леверидж — moat 1 (не лидер)"),
    "RUAL": (1, 0, 1, -1, 0, 0, "Алюминий — металл электрификации (Гл.11, тектоника уже +g); долг/санкции/governance (reg-1)"),
    "ENPG": (1, 0, 1, -1, 0, 0, "Алюминий+гидрогенерация, электрификация (Гл.11); санкции/governance/тариф (reg-1)"),
    "BSPB": (1, 0, 0, 0, 0, 0, "Эффективный региональный банк, дешёвый, высокий ROE; без системного рва — нишевый"),
    "SVCB": (1, 0, 0, 0, 0, 0, "Растущий банк-консолидатор (M&A); рост не органический moat, короткий ROIC"),
}
